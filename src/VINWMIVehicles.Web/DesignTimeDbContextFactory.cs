...
/// </summary>
public class AppDbContextVinDesignTimeFactory : IDesignTimeDbContextFactory<AppDbContextVin>
{
    public AppDbContextVin CreateDbContext(string[] args)
    {
        ...
        var optionsBuilder = new DbContextOptionsBuilder<AppDbContextVin>();
        optionsBuilder.UseNpgsql(cs, o =>
        {
            o.MigrationsAssembly("SharedServices");
        });

        return new AppDbContextVin(optionsBuilder.Options);
    }
}
